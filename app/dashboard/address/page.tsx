      ...
      <DashboardLayout>
        <div className="space-y-4">
          <div className='bg-[#804A9D14] w-full p-[1rem] md:p-[2rem]'>
            ...
            <Button onClick={() => setAddNewAdress(!addNewAdress)} className='mt-[1.19rem] bg-transparent text-[0.875rem] border border-black text-black w-[22rem]'>
              ...
              address ? <div className='w-full flex flex-col gap-y-[1rem]'>
                {address?.map((address, index) => {
                  return <div key={index?.toString()} className='flex flex-col md:flex-row justify-between bg-[#804A9D14] p-[1rem]'>
                    <div className='w-[70%] flex flex-col items-start justify-start gap-y-[1rem]'>
                    ...
                    <div className='flex flex-col w-auto'>
                      ...
                      <Button onClick={() => handleDeleteAddress(address?.address_id)} className='mt-[1.5rem] bg-transparent text-black space-x-1 border-none shadow-none'>
