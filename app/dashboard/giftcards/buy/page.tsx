...
export default function page() {
    ...
    return (
        <Navigation>
            <DashboardLayout>
                <div className='relative z-[12] w-full h-full my-[2rem] lg:my-[2.5rem] flex flex-col gap-y-[1.5rem] p-[2rem] shadow-md rounded-[1.25rem]'>
                    ...
                    <div className='relative z-[12] flex flex-col md:flex-row md:gap-x-[1rem]'>
                        <div className='w-[50%]'>
                            <div>
                            ...
                            {
                                designImage && <div className="w-[70%] relative h-[15rem] mt-[2.5rem]">
                                    <NextImage
                                        src={designImage}
                                        width={40}
                                        height={40}
                        ...
                        <div className='w-full max-w-[60%] flex flex-col gap-y-[0.8rem]'>
