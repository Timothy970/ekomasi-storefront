                ...
                <div className='mt-[2rem] w-full max-w-[90rem] px-[1rem] lg:px-[3rem]'>
                    <div className='w-full flex items-center justify-between flex-col md:flex-row'>
                        ...
                        <div className='flex gap-x-[1rem] w-full justify-center md:justify-end items-center mx-auto mt-[1rem] md:mt-[1rem]'>
                            <Button className='bg-[rgba(232,41,138,0.25)] border text-[0.875rem] border-[rgba(232,41,138,0.25)] text-custom-black h-[2rem] w-[10rem] flex gap-x-[0.75rem] md:rounded-[0.5rem]'>
                            ...
                            <Button className='bg-white text-custom-black text-[0.875rem] h-[2rem] border border-black w-[10rem] md:rounded-[0.5rem]'>
                                Clear All
                            </Button>
                        </div>
                    </div>
                                                    ...
                                                    return <Link key={index?.toString()} href={`/product/${product?.product_id}`}>
                                                        <div className="overflow-hidden flex flex-col justify-center items-center">
                                                            ...
                                                            <div className=" pb-3 flex flex-col gap-y-[0.5rem] mt-[0.75rem] w-full justify-center">
                                                                <h3 className="text-[0.875rem] font-semibold">{product.name}</h3>
                                                                ...
                                                                <div className='flex justify-between items-center'>
                                                                    ...
                                                                    <Button className='bg-white border border-[#7A4597] h-[2rem] md:w-[5rem] text-[#7A4597] text-[0.875rem]'>
                                                                        Remove
                                                                    </Button>
