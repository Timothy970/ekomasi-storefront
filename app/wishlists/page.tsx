                ...
                <div className='mt-[2rem] w-full max-w-[90rem] px-[1rem] lg:px-[3rem]'>
                    <div className='w-full flex items-center justify-between flex-col md:flex-row'>
                        ...
                        <div className='flex gap-x-[1rem] w-full justify-center md:justify-end items-center mx-auto mt-[1rem] md:mt-[1rem]'>
                            <Button className='bg-[rgba(232,41,138,0.25)] border text-base border-[rgba(232,41,138,0.25)] text-[#031026] h-[2rem] w-[10rem] flex gap-x-[0.75rem] md:rounded-[0.5rem]'>
                            ...
                            <Button className='bg-white text-[#031026] text-base h-[2rem] border border-black w-[10rem] md:rounded-[0.5rem]'>
                                Clear All
                            </Button>
                        </div>
                    </div>
