    ...
    return (
        <Navigation>
            <div className='w-full flex flex-col justify-center items-center'>
                <div className='w-full bg-[rgba(232,41,138,0.25)] h-[3rem] text-center flex justify-center items-center'>
                    <p className='text-base'>Our Big Little Event is now on | Shop up to 40% off</p>
                </div>

                <div className='mt-[2rem] w-full max-w-[90rem] px-[1rem] lg:px-[4rem]'>
                    <div className='w-full flex items-center justify-between flex-col md:flex-row'>
                        ...
                        <div className='flex gap-x-[1rem] w-full justify-center md:justify-end items-center mx-auto mt-[1rem] md:mt-[1rem]'>
                            <Button className='bg-[rgba(232,41,138,0.25)] border text-base border-[rgba(232,41,138,0.25)] text-black h-[3rem] w-[10rem] flex gap-x-[0.75rem] md:rounded-[0.5rem]'>
                            ...
                            <Button className='bg-white text-black text-base h-[3rem] border border-black w-[10rem] md:rounded-[0.5rem]'>
                                Clear All
                            </Button>
                        </div>
                    </div>
                                                        ...
                                                        <div className="overflow-hidden flex flex-col justify-center items-center">
                                                            ...
                                                            <div className=" pb-3 flex flex-col gap-y-[0.5rem] mt-[0.75rem] w-full justify-center">
                                                                ...
                                                                <div className='flex justify-between items-center'>
                                                                    <Button className="w-[5.4rem] md:w-[11rem] md:items-center rounded-[0.125rem] bg-[#AF52DE] h-[3rem] font-semibold flex gap-x-[0.25] md:gap-[0.75rem]">
                                                                    ...
                                                                    <Button className='bg-white border border-[#7A4597] h-[3rem] md:w-[5rem] text-[#7A4597] text-base'>
                                                                        Remove
                                                                    </Button>
