    ...
    return (
        <div className="w-full flex justify-center items-center py-12">
            <div className="w-full">
                <div className="flex items-end justify-between gap-4 mb-8 mx-auto max-w-[90rem] px-[1rem] lg:px-[3rem]">
                    <div>
                    ...
                    <div className="w-full max-w-[90rem]">
                        <AnimatePresence initial={false} mode="wait">
                            <motion.div
                                ...
                                className="relative w-full z-10 text-start px-[1rem] lg:px-[3rem] flex flex-col items-start"
                            >
