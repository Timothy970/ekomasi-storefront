            ...
            <div className="w-full max-w-[90rem] px-4 lg:px-[4rem]">
                <div className="flex items-end justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="pt-2 text-black/70 text-sm leading-[1.3125rem]">
                            Tap the arrows to slide testimonials. Animated with Framer Motion.
                        </p>
                    </div>
                </div>

                <div className="relative h-[33rem] md:h-[20rem] lg:h-[25rem] flex items-center justify-center overflow-hidden">
                    <svg
                    ...
                    <AnimatePresence initial={false} mode="wait">
                        ...
                        >
                            <div className="flex justify-start mb-4 gap-[0.5rem] lg:hidden">
                                {Array.from({ length: slides[index].stars }).map((_, i) => (
                                    <Star key={i} size={24} color="#AF52DE" />
                                ))}
                            </div>

                            <div className="relative lg:p-4 lg:px-[2.5rem] z-10 flex justify-start items-center">
                                <svg className="lg:absolute hidden lg:block left-0 top-[0.5rem]" xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="none">
                                ...
                                <p className="text-black/80 text-base lg:text-[1.5rem] leading-relaxed py-4 mt-[1.25rem]">
                                    {slides[index].testimony}
                                </p>
                                <svg className="right-0 absolute hidden lg:block bottom-[0.5rem]" xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="none">
                            ...
                            <div className="flex flex-col">
                                <h4 className="text-lg font-semibold text-black mt-[1.25rem]">
                                    {slides[index].name}
                                </h4>
