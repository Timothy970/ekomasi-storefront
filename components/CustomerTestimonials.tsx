            ...
            <div className="w-full max-w-[90rem] px-[1rem] lg:px-[3rem]">
                <div className="flex items-end justify-between gap-4 mb-8 ">
                    <div>
                        ...
                        <p className="pt-2 text-custom-black/70 text-sm leading-[1.3125rem]">
                    ...
                    <AnimatePresence initial={false} mode="wait">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex justify-start items-center">
                                ...
                                <p className="text-custom-black/80 text-base lg:text-[1.5rem] leading-relaxed py-[2rem] lg:py-[3rem]">
