        ...
        return (
          ...
          >
            <div className="relative w-1/3 h-[13.5rem] md:h-[20rem] max-h-[25rem] flex-shrink-0">
              <Image
                src={firstItem?.product_image || 'https://images.unsplash.com/photo-1612722432474-b971cdcea546?q=80&w=627&auto=format&fit=crop&ixlib=rb-4.1.0'}
            ...
            <div className="flex w-full flex-col pl-4 lg:flex-row">
              <div className="flex-1 flex flex-col gap-y-[0.88rem]">
                ...
                <Link href={`/orders/${order.order_id}`} className="flex items-center justify-start gap-x-[1rem]">
