...
export function FilterSortBy() {
  return (
    <Select>
      <SelectTrigger className="border bg-white text-custom-black h-[2.5rem] lg:h-[2rem] min-w-[10rem] rounded-none lg:rounded-md flex gap-x-[1rem] lg:border lg:border-black">
