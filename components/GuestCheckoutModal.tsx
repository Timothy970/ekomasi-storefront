            ...
            <div className='bg-white flex hide-scrollbar flex-col items-center justify-center p-[3rem] gap-y-[1rem] m-[1rem] overflow-y-scroll z-[70]'>
                <div className='mb-[2rem] border-b border-black pb-[2rem]'>
                    ...
                    <div className='mt-[2rem] flex flex-col gap-y-[1rem]'>
                        <Button onClick={() => handleLogin()} className='h-[2.5rem] rounded-[1.5rem] flex items-center justify-center gap-x-[0.75rem] text-[0.875rem]'>
                        ...
                        <Button onClick={() => handleCreateAccount()} className='h-[2.5rem] rounded-[1.5rem] flex items-center justify-center gap-x-[0.75rem] text-[0.875rem]'>
