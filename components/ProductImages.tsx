...
export default function ProductImages() {
    ...
    return (
        <div className="w-full h-full flex flex-row justify-between">
            <div className="w-[30%] flex flex-col gap-y-[1rem] p-2">
            ...
            <div className="relative w-[65%] overflow-hidden">
                <div className="absolute inset-0 flex flex-col justify-start items-center text-center z-10">
                    <div className="p-4 h-full w-full flex justify-start">
                        <Button className='bg-white text-black px-[1.5rem] rounded-[2.5rem]'>
