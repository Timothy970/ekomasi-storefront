...
export default function TalkToUs() {
    return (
        <div className='w-full max-w-[90rem] mx-auto flex justify-center items-center py-12 bg-[rgba(148,35,117,0.08)]'>
            <div className='max-w-[90rem] px-4 lg:px-[4rem] w-full md:flex md:flex-row-reverse gap-[4rem]'>
                ...
                <div className='flex flex-col gap-6 mt-6 md:w-1/2'>
                    ...
                    <p className='text-black font-poppins text-base font-normal leading-[1.95rem]'>
                    ...
                    <Button className='max-w-[8rem] w-full text-white font-poppins text-base font-bold leading-[1.5rem] bg-[#9333EA] h-[3rem]'>
                        Talk to us
                    </Button>
                </div>
            </div>
