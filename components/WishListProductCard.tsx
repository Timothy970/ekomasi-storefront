...
export default function WishListProductCard({ product, pageType }: Readonly<{ product: Product; pageType: "wishlist" | "shared" }>) {
    ...
    return (
        <div className="flex flex-col justify-between h-full">
            <Link
                ...
                className="block cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary-tenant rounded"
            >
            ...
            <div className='flex justify-between items-center mt-1'>
                ...
                {pageType === "wishlist" && (
                    <Button
                        ...
                        className='text-red-400 mr-[1.25rem] md:hidden h-auto w-auto p-1 hover:bg-transparent'>
